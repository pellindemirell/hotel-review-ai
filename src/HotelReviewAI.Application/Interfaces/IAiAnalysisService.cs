...
public interface IAiAnalysisService
{
    ...
    /// <summary>
    /// Metni Türkçeye çevirir. Metin zaten Türkçeyse aynen döner.
    /// AI servisi erişilemez olduğunda null döner (graceful degradation).
    /// </summary>
    Task<AiTranslationResult?> TranslateToTurkishAsync(string text, string? sourceLanguage, CancellationToken ct = default);
    ...
    /// <summary>
    /// AI servisinin hazır olup olmadığını /health endpoint'i üzerinden kontrol eder.
    /// </summary>
