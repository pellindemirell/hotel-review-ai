...
_DEPENDENCY_CHAINS: dict[str, list[dict[str, str]]] = {
    ...
    "Staff Training Deficiency": [
        {"department": "Personel Davranışı", "process": "Recruitment", "status": "unknown"},
        {"department": "Personel Davranışı", "process": "Onboarding Training", "status": "unknown"},
